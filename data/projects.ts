    ...
    summaryCards: [
      {
        title: "Problem",
        items: [
          "신진 작가는 작품을 지속적으로 소개할 채널이 필요함",
          "구매자는 작품·작가·전시 정보를 한 곳에서 비교하기 어려움",
          "작품 구매 전에는 가격보다 취향과 공간에서의 모습 확인이 먼저 필요함"
        ]
      },
      {
        title: "Product",
        items: [
          "작품·작가 탐색, 검색·필터, 찜과 문의 흐름 구현",
          "취향 추천 퀴즈와 실제 공간 미리보기 제공",
          "작가 제출·관리자 검토와 전시 카탈로그 운영"
        ]
      },
      {
        title: "Engineering",
        items: [
          "한국어·영어 전환과 작품별 언어 데이터 구조 적용",
          "Vercel 인프라 제약을 확인하고 GitHub Actions 기반 정적 데이터 스냅샷 파이프라인으로 전환",
          "데스크톱·모바일 실브라우저 검증으로 배포 품질 관리"
        ]
      }
    ]
  },
